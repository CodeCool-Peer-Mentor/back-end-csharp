...
namespace Codecool.PeerMentors.Migrations
{
    ...
    [Migration("20201125215739_AddReviewsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codecool.PeerMentors.Entities.Answer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Codecool.PeerMentors.Entities.Review", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Codecool.PeerMentors.Entities.Review", b =>
                {
                    b.HasOne("Codecool.PeerMentors.Entities.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Codecool.PeerMentors.Entities.User", "Reviewer")
                        .WithMany("Reviews")
